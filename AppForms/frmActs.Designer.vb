...
Partial Public Class frmActs
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentResourceManager = New ComponentResourceManager(GetType(frmActs))
        ...
        CType(dgvActs, ISupportInitialize).BeginInit()
        ...
        GroupBox1.Size = New Size(819, 419)
        GroupBox1.TabIndex = 2
        GroupBox1.TabStop = False
        GroupBox1.Text = "ادخل بيانات وتعريف انشطة ومجالات العمل "
        ' 
        ' dgvActs
        ' 
        ...
        dgvActs.Location = New Point(120, 118)
        dgvActs.Margin = New Padding(3, 4, 3, 4)
        dgvActs.MultiSelect = False
        dgvActs.Name = "dgvActs"
        dgvActs.ReadOnly = True
        dgvActs.RowHeadersWidth = 51
        dgvActs.RowTemplate.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter
        dgvActs.SelectionMode = DataGridViewSelectionMode.FullRowSelect
        dgvActs.Size = New Size(589, 261)
        dgvActs.TabIndex = 4
        ' 
        ' Column2
        ' 
        ...
        txtName.Location = New Point(139, 48)
        ...
        Label1.Location = New Point(632, 52)
        Label1.Name = "Label1"
        Label1.Size = New Size(84, 17)
        Label1.TabIndex = 2
        Label1.Text = "مجال العمل"
        ' 
        ' btnNext
        ' 
        ...
        toolStrip1.Size = New Size(817, 65)
        ...
        Text = "تعريف مجالات العمل"
        GroupBox1.ResumeLayout(False)
        GroupBox1.PerformLayout()
        CType(dgvActs, ISupportInitialize).EndInit()
