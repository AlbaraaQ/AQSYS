...
Private conn As SqlConnection
		...
		Public Sub New()
			...
			frmRptItemsDaily.__ENCAddToList(Me)
			Me.conn = MainClass.ConnObj()
			Me.InitializeComponent()
		End Sub
		Private Shared Sub __ENCAddToList(value As Object)
			Dim _ENCList As List(Of WeakReference) = frmRptItemsDaily.__ENCList
			Dim flag As Boolean = False
			Try
				Monitor.Enter(_ENCList, flag)
				Dim flag2 As Boolean = frmRptItemsDaily.__ENCList.Count = frmRptItemsDaily.__ENCList.Capacity
				If flag2 Then
					Dim num As Integer = 0
					Dim num2 As Integer = 0
					Dim num3 As Integer = frmRptItemsDaily.__ENCList.Count - 1
					...
					While True
						...
						If num5 > num6 Then
							Exit While
						End If
						Dim weakReference As WeakReference = frmRptItemsDaily.__ENCList(num4)
						flag2 = weakReference.IsAlive
						If flag2 Then
							Dim flag3 As Boolean = num4 <> num
							If flag3 Then
								frmRptItemsDaily.__ENCList(num) = frmRptItemsDaily.__ENCList(num4)
							End If
							num += 1
						End If
						num4 += 1
					End While
					frmRptItemsDaily.__ENCList.RemoveRange(num, frmRptItemsDaily.__ENCList.Count - num)
					frmRptItemsDaily.__ENCList.Capacity = frmRptItemsDaily.__ENCList.Count
				End If
				frmRptItemsDaily.__ENCList.Add(New WeakReference(RuntimeHelpers.GetObjectValue(value)))
			Finally
	...
	Private Sub Button4_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnShow.Click
		Try
			...
			While True
				...
				sqlDataAdapter2.SelectCommand.Parameters.Add("@date2", SqlDbType.DateTime).Value = Me.txtDateFrom.Value.AddDays(1.0).ToShortDateString()
				Dim dataTable2 As DataTable = New DataTable()
