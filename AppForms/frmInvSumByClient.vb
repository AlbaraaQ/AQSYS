...
Public Partial Class frmInvSumByClient
    Inherits Form
    ...
    Public Sub New()
        ...
        frmInvSumByClient.__ENCAddToList(Me)
    ...
    Private Shared Sub __ENCAddToList(value As Object)
        Dim _ENCList As List(Of WeakReference) = frmInvSumByClient.__ENCList
        Dim flag As Boolean = False
        Try
            Monitor.Enter(_ENCList, flag)
            Dim flag2 As Boolean = frmInvSumByClient.__ENCList.Count = frmInvSumByClient.__ENCList.Capacity
            If flag2 Then
                Dim num As Integer = 0
                Dim num2 As Integer = 0
                Dim num3 As Integer = frmInvSumByClient.__ENCList.Count - 1
                ...
                While True
                    ...
                    If num5 > num6 Then
                        Exit While
                    End If
                    Dim weakReference As WeakReference = frmInvSumByClient.__ENCList(num4)
                    flag2 = weakReference.IsAlive
                    If flag2 Then
                        Dim flag3 As Boolean = num4 <> num
                        If flag3 Then
                            frmInvSumByClient.__ENCList(num) = frmInvSumByClient.__ENCList(num4)
                        End If
                        num += 1
                    End If
                    num4 += 1
                End While
                frmInvSumByClient.__ENCList.RemoveRange(num, frmInvSumByClient.__ENCList.Count - num)
                frmInvSumByClient.__ENCList.Capacity = frmInvSumByClient.__ENCList.Count
            End If
            frmInvSumByClient.__ENCList.Add(New WeakReference(RuntimeHelpers.GetObjectValue(value)))
        Finally
    ...
    Private Sub frmInvSumByClient_Load(ByVal sender As Object, ByVal e As EventArgs)
    ...
    Private Sub PrintRpt(type As Integer)
        ...
        Else
            ...
            End If
            Dim textObject As TextObject = CType(NewLateBinding.LateGet(NewLateBinding.LateGet(NewLateBinding.LateGet(obj, Nothing, "ReportDefinition", New Object(-1) {}, Nothing, Nothing, Nothing), Nothing, "Sections", New Object() {1}, Nothing, Nothing, Nothing), Nothing, "ReportObjects", New Object() {"txtcust"}, Nothing, Nothing, Nothing), TextObject)
            textObject.Text = Me.CustName
    ...
    Private Sub Button4_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnShow.Click
        Try
            ...
            Else
                ...
                If flag Then
                    str = Conversions.ToString(Operators.ConcatenateObject(Operators.ConcatenateObject(" inv.cust_id=", Me.cmbClients.SelectedValue), " and "))
                End If
                Dim str2 As String = ""
                ...
                flag = Not Me.chkAll.Checked
                If flag Then
                    Me.CustName = Me.cmbClients.Text
                Else
                    Me.CustName = "الكل"
                End If
                ...
                While True
                    ...
                    Dim value As String = ""
                    flag = (Conversion.Val(RuntimeHelpers.GetObjectValue(dataTable.Rows(num5)("inv_type"))) = 1.0)
                    If flag Then
                        value = "آجلة"
                    Else
                        flag = (Conversion.Val(RuntimeHelpers.GetObjectValue(dataTable.Rows(num5)("inv_type"))) = 2.0)
                        If flag Then
                            value = "نقدية"
                        End If
                    End If
                    ...
                    flag = Convert.ToBoolean(RuntimeHelpers.GetObjectValue(dataTable.Rows(num5)("is_buy")))
                    If flag Then
    ...
    Private Sub Button11_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Button11.Click
        Try
            'New frmSrchClient() With { .Form_Type = 2, .frm2 = Me }.ShowDialog()
