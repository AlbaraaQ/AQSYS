...
Imports System.Xml.Serialization
	<DesignerCategory("code"), XmlSchemaProvider("GetTypedDataSetSchema"), ToolboxItem(True), XmlRoot("dsInvByTypeClient"), HelpKeyword("vs.data.DataSet"), Serializable()>
	Public Class dsInvByTypeClient
		Inherits DataSet

		Private Shared __ENCList As List(Of WeakReference) = New List(Of WeakReference)()

		Private tableDataTable1 As dsInvByTypeClient.DataTable1DataTable

		Private _schemaSerializationMode As SchemaSerializationMode
		Shared Sub New()
		End Sub
		Private Shared Sub __ENCAddToList(value As Object)
			Dim _ENCList As List(Of WeakReference) = dsInvByTypeClient.__ENCList
			Dim flag As Boolean = False
			Try
				Monitor.Enter(_ENCList, flag)
				Dim flag2 As Boolean = dsInvByTypeClient.__ENCList.Count = dsInvByTypeClient.__ENCList.Capacity
				If flag2 Then
					Dim num As Integer = 0
					Dim num2 As Integer = 0
					Dim num3 As Integer = dsInvByTypeClient.__ENCList.Count - 1
					...
					While True
						...
						If num5 > num6 Then
							Exit While
						End If
						Dim weakReference As WeakReference = dsInvByTypeClient.__ENCList(num4)
						flag2 = weakReference.IsAlive
						If flag2 Then
							Dim flag3 As Boolean = num4 <> num
							If flag3 Then
								dsInvByTypeClient.__ENCList(num) = dsInvByTypeClient.__ENCList(num4)
							End If
							num += 1
						End If
						num4 += 1
					End While
					dsInvByTypeClient.__ENCList.RemoveRange(num, dsInvByTypeClient.__ENCList.Count - num)
					dsInvByTypeClient.__ENCList.Capacity = dsInvByTypeClient.__ENCList.Count
				End If
				dsInvByTypeClient.__ENCList.Add(New WeakReference(RuntimeHelpers.GetObjectValue(value)))
			Finally
		...
		Public Sub New()
			dsInvByTypeClient.__ENCAddToList(Me)
		...
		Protected Sub New(info As SerializationInfo, context As StreamingContext)
			...
			Else
				...
				If flag Then
					...
					If flag Then
						MyBase.Tables.Add(New dsInvByTypeClient.DataTable1DataTable(dataSet.Tables("DataTable1")))
					End If
		...
		Public ReadOnly Property DataTable1 As dsInvByTypeClient.DataTable1DataTable
			Get
		...
		Public Overrides Function Clone() As DataSet
			Dim dsInvByTypeClient As dsInvByTypeClient = CType(MyBase.Clone(), dsInvByTypeClient)
			dsInvByTypeClient.InitVars()
			dsInvByTypeClient.SchemaSerializationMode = Me.SchemaSerializationMode
			Return dsInvByTypeClient
		End Function
		...
		Friend Sub InitVars(initTable As Boolean)
			Me.tableDataTable1 = CType(MyBase.Tables("DataTable1"), dsInvByTypeClient.DataTable1DataTable)
			If initTable Then
		...
		Private Sub InitClass()
			Me.DataSetName = "dsInvByTypeClient"
			Me.Prefix = ""
			Me.[Namespace] = "http://tempuri.org/dsInvByTypeClient.xsd"
			Me.EnforceConstraints = True
			Me.SchemaSerializationMode = SchemaSerializationMode.IncludeSchema
			Me.tableDataTable1 = New dsInvByTypeClient.DataTable1DataTable()
		...
		Public Shared Function GetTypedDataSetSchema(xs As XmlSchemaSet) As XmlSchemaComplexType
			Dim dsInvByTypeClient As dsInvByTypeClient = New dsInvByTypeClient()
			...
			xmlSchemaAny.[Namespace] = dsInvByTypeClient.[Namespace]
			xmlSchemaSequence.Items.Add(xmlSchemaAny)
			xmlSchemaComplexType.Particle = xmlSchemaSequence
			Dim schemaSerializable As XmlSchema = dsInvByTypeClient.GetSchemaSerializable()
		...
		Public Delegate Sub DataTable1RowChangeEventHandler(sender As Object, e As dsInvByTypeClient.DataTable1RowChangeEvent)

		<XmlSchemaProvider("GetTypedTableSchema"), Serializable()>
		Public Class DataTable1DataTable
			Inherits TypedTableBase(Of dsInvByTypeClient.DataTable1Row)
			...
			Private columnsumpurch As DataColumn

			Private columnsumsale As DataColumn
			...
			End Sub
			Private Shared Sub __ENCAddToList(value As Object)
				Dim _ENCList As List(Of WeakReference) = dsInvByTypeClient.DataTable1DataTable.__ENCList
				Dim flag As Boolean = False
				Try
					Monitor.Enter(_ENCList, flag)
					Dim flag2 As Boolean = dsInvByTypeClient.DataTable1DataTable.__ENCList.Count = dsInvByTypeClient.DataTable1DataTable.__ENCList.Capacity
					If flag2 Then
						Dim num As Integer = 0
						Dim num2 As Integer = 0
						Dim num3 As Integer = dsInvByTypeClient.DataTable1DataTable.__ENCList.Count - 1
						Dim num4 As Integer = num2
						While True
							Dim num5 As Integer = num4
							Dim num6 As Integer = num3
							If num5 > num6 Then
								Exit While
							End If
							Dim weakReference As WeakReference = dsInvByTypeClient.DataTable1DataTable.__ENCList(num4)
							flag2 = weakReference.IsAlive
							If flag2 Then
								Dim flag3 As Boolean = num4 <> num
								If flag3 Then
									dsInvByTypeClient.DataTable1DataTable.__ENCList(num) = dsInvByTypeClient.DataTable1DataTable.__ENCList(num4)
								End If
								num += 1
							End If
							num4 += 1
						End While
						dsInvByTypeClient.DataTable1DataTable.__ENCList.RemoveRange(num, dsInvByTypeClient.DataTable1DataTable.__ENCList.Count - num)
						dsInvByTypeClient.DataTable1DataTable.__ENCList.Capacity = dsInvByTypeClient.DataTable1DataTable.__ENCList.Count
					End If
					dsInvByTypeClient.DataTable1DataTable.__ENCList.Add(New WeakReference(RuntimeHelpers.GetObjectValue(value)))
				Finally
					Dim flag3 As Boolean = flag
					If flag3 Then
						Monitor.[Exit](_ENCList)
			...
			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode()>
			Public Sub New()
				dsInvByTypeClient.DataTable1DataTable.__ENCAddToList(Me)
			...
			<DebuggerNonUserCode(), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public ReadOnly Property sumpurchColumn As DataColumn
				Get
					Return Me.columnsumpurch
				End Get
			End Property

			<DebuggerNonUserCode(), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public ReadOnly Property sumsaleColumn As DataColumn
				Get
					Return Me.columnsumsale
				End Get
			End Property
			...
			<DebuggerNonUserCode(), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public ReadOnly Default Property Item(index As Integer) As dsInvByTypeClient.DataTable1Row
				Get
					Return CType(Me.Rows(index), dsInvByTypeClient.DataTable1Row)
				End Get
			End Property

			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Event DataTable1RowChanging As dsInvByTypeClient.DataTable1RowChangeEventHandler

			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Event DataTable1RowChanged As dsInvByTypeClient.DataTable1RowChangeEventHandler

			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Event DataTable1RowDeleting As dsInvByTypeClient.DataTable1RowChangeEventHandler

			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Event DataTable1RowDeleted As dsInvByTypeClient.DataTable1RowChangeEventHandler

			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode()>
			Public Sub AddDataTable1Row(row As dsInvByTypeClient.DataTable1Row)
				Me.Rows.Add(row)
			End Sub

			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode()>
			Public Function AddDataTable1Row(type As String, no As String, _date As String, sumpurch As String, sumsale As String, DataColumn11 As String, DataColumn1 As String) As dsInvByTypeClient.DataTable1Row
				Dim dataTable1Row As dsInvByTypeClient.DataTable1Row = CType(Me.NewRow(), dsInvByTypeClient.DataTable1Row)
				Dim itemArray As Object() = New Object() { type, no, _date, sumpurch, sumsale, DataColumn11, DataColumn1 }
			...
			Public Overrides Function Clone() As DataTable
				Dim dataTable1DataTable As dsInvByTypeClient.DataTable1DataTable = CType(MyBase.Clone(), dsInvByTypeClient.DataTable1DataTable)
			...
			Protected Overrides Function CreateInstance() As DataTable
				Return New dsInvByTypeClient.DataTable1DataTable()
			End Function
			...
			Friend Sub InitVars()
				...
				Me.columnsumpurch = MyBase.Columns("sumpurch")
				Me.columnsumsale = MyBase.Columns("sumsale")
			...
			Private Sub InitClass()
				...
				Me.columnsumpurch = New DataColumn("sumpurch", GetType(String), Nothing, MappingType.Element)
				MyBase.Columns.Add(Me.columnsumpurch)
				Me.columnsumsale = New DataColumn("sumsale", GetType(String), Nothing, MappingType.Element)
				MyBase.Columns.Add(Me.columnsumsale)
				...
				Me.columntype.Caption = "DataColumn1"
				Me.columnno.Caption = "DataColumn1"
				Me.columndate.Caption = "DataColumn1"
				Me.columnsumpurch.Caption = "DataColumn1"
				Me.columnsumsale.Caption = "DataColumn1"
				Me.columnDataColumn11.Caption = "DataColumn1"
			End Sub

			<DebuggerNonUserCode(), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Function NewDataTable1Row() As dsInvByTypeClient.DataTable1Row
				Return CType(Me.NewRow(), dsInvByTypeClient.DataTable1Row)
			End Function

			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode()>
			Protected Overrides Function NewRowFromBuilder(builder As DataRowBuilder) As DataRow
				Return New dsInvByTypeClient.DataTable1Row(builder)
			End Function

			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode()>
			Protected Overrides Function GetRowType() As Type
				Return GetType(dsInvByTypeClient.DataTable1Row)
			End Function
			...
			Protected Overrides Sub OnRowChanged(e As DataRowChangeEventArgs)
				...
				If flag Then
					Dim dataTable1RowChangedEvent As dsInvByTypeClient.DataTable1RowChangeEventHandler = Me.DataTable1RowChangedEvent
					flag = (dataTable1RowChangedEvent IsNot Nothing)
					If flag Then
						dataTable1RowChangedEvent(Me, New dsInvByTypeClient.DataTable1RowChangeEvent(CType(e.Row, dsInvByTypeClient.DataTable1Row), e.Action))
					End If
				End If
			End Sub
			...
			Protected Overrides Sub OnRowChanging(e As DataRowChangeEventArgs)
				...
				If flag Then
					Dim dataTable1RowChangingEvent As dsInvByTypeClient.DataTable1RowChangeEventHandler = Me.DataTable1RowChangingEvent
					flag = (dataTable1RowChangingEvent IsNot Nothing)
					If flag Then
						dataTable1RowChangingEvent(Me, New dsInvByTypeClient.DataTable1RowChangeEvent(CType(e.Row, dsInvByTypeClient.DataTable1Row), e.Action))
					End If
				End If
			End Sub
			...
			Protected Overrides Sub OnRowDeleted(e As DataRowChangeEventArgs)
				...
				If flag Then
					Dim dataTable1RowDeletedEvent As dsInvByTypeClient.DataTable1RowChangeEventHandler = Me.DataTable1RowDeletedEvent
					flag = (dataTable1RowDeletedEvent IsNot Nothing)
					If flag Then
						dataTable1RowDeletedEvent(Me, New dsInvByTypeClient.DataTable1RowChangeEvent(CType(e.Row, dsInvByTypeClient.DataTable1Row), e.Action))
					End If
				End If
			End Sub
			...
			Protected Overrides Sub OnRowDeleting(e As DataRowChangeEventArgs)
				...
				If flag Then
					Dim dataTable1RowDeletingEvent As dsInvByTypeClient.DataTable1RowChangeEventHandler = Me.DataTable1RowDeletingEvent
					flag = (dataTable1RowDeletingEvent IsNot Nothing)
					If flag Then
						dataTable1RowDeletingEvent(Me, New dsInvByTypeClient.DataTable1RowChangeEvent(CType(e.Row, dsInvByTypeClient.DataTable1Row), e.Action))
					End If
				End If
			End Sub

			<DebuggerNonUserCode(), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Sub RemoveDataTable1Row(row As dsInvByTypeClient.DataTable1Row)
				Me.Rows.Remove(row)
			End Sub
			...
			Public Shared Function GetTypedTableSchema(xs As XmlSchemaSet) As XmlSchemaComplexType
				...
				xmlSchemaAttribute.FixedValue = dsInvByTypeClient.[Namespace]
		...
		Public Class DataTable1Row
			...
			Friend Sub New(rb As DataRowBuilder)
				MyBase.New(rb)
				Me.tableDataTable1 = CType(Me.Table, dsInvByTypeClient.DataTable1DataTable)
			End Sub
			...
			Public Property type As String
				Get
					...
					Try
						result = Conversions.ToString(Me(Me.tableDataTable1.typeColumn))
			...
			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode()>
			Public Property sumpurch As String
				Get
					Dim result As String
					Try
						result = Conversions.ToString(Me(Me.tableDataTable1.sumpurchColumn))
					Catch innerException As InvalidCastException
						Throw New StrongTypingException("The value for column 'sumpurch' in table 'DataTable1' is DBNull.", innerException)
					End Try
					Return result
				End Get
				Set(value As String)
					Me(Me.tableDataTable1.sumpurchColumn) = value
				End Set
			End Property

			<DebuggerNonUserCode(), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Property sumsale As String
				Get
					Dim result As String
					Try
						result = Conversions.ToString(Me(Me.tableDataTable1.sumsaleColumn))
					Catch innerException As InvalidCastException
						Throw New StrongTypingException("The value for column 'sumsale' in table 'DataTable1' is DBNull.", innerException)
					End Try
					Return result
				End Get
				Set(value As String)
					Me(Me.tableDataTable1.sumsaleColumn) = value
				End Set
			End Property
			...
			Public Sub SettypeNull()
				Me(Me.tableDataTable1.typeColumn) = RuntimeHelpers.GetObjectValue(Convert.DBNull)
			End Sub
			...
			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode()>
			Public Function IssumpurchNull() As Boolean
				Return Me.IsNull(Me.tableDataTable1.sumpurchColumn)
			End Function

			<DebuggerNonUserCode(), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Sub SetsumpurchNull()
				Me(Me.tableDataTable1.sumpurchColumn) = RuntimeHelpers.GetObjectValue(Convert.DBNull)
			End Sub

			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode()>
			Public Function IssumsaleNull() As Boolean
				Return Me.IsNull(Me.tableDataTable1.sumsaleColumn)
			End Function

			<DebuggerNonUserCode(), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Sub SetsumsaleNull()
				Me(Me.tableDataTable1.sumsaleColumn) = RuntimeHelpers.GetObjectValue(Convert.DBNull)
			End Sub
		...
		Public Class DataTable1RowChangeEvent
			...
			Private eventRow As dsInvByTypeClient.DataTable1Row

			Private eventAction As DataRowAction

			<DebuggerNonUserCode(), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Sub New(row As dsInvByTypeClient.DataTable1Row, action As DataRowAction)
				Me.eventRow = row
				Me.eventAction = action
			End Sub

			<DebuggerNonUserCode(), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public ReadOnly Property Row As dsInvByTypeClient.DataTable1Row
				Get
					Return Me.eventRow
				End Get
			End Property
