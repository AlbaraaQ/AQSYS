...
Imports System.Xml.Serialization
	<XmlSchemaProvider("GetTypedDataSetSchema"), HelpKeyword("vs.data.DataSet"), DesignerCategory("code"), XmlRoot("dsNetProfit"), ToolboxItem(True), Serializable()>
	Public Class dsNetProfit
		Inherits DataSet

		Private Shared __ENCList As List(Of WeakReference) = New List(Of WeakReference)()

		Private tableDataTable1 As dsNetProfit.DataTable1DataTable

		Private _schemaSerializationMode As SchemaSerializationMode
		Shared Sub New()
		End Sub
		Private Shared Sub __ENCAddToList(value As Object)
			Dim _ENCList As List(Of WeakReference) = dsNetProfit.__ENCList
			Dim flag As Boolean = False
			Try
				Monitor.Enter(_ENCList, flag)
				Dim flag2 As Boolean = dsNetProfit.__ENCList.Count = dsNetProfit.__ENCList.Capacity
				If flag2 Then
					Dim num As Integer = 0
					Dim num2 As Integer = 0
					Dim num3 As Integer = dsNetProfit.__ENCList.Count - 1
					...
					While True
						...
						If num5 > num6 Then
							Exit While
						End If
						Dim weakReference As WeakReference = dsNetProfit.__ENCList(num4)
						flag2 = weakReference.IsAlive
						If flag2 Then
							Dim flag3 As Boolean = num4 <> num
							If flag3 Then
								dsNetProfit.__ENCList(num) = dsNetProfit.__ENCList(num4)
							End If
							num += 1
						End If
						num4 += 1
					End While
					dsNetProfit.__ENCList.RemoveRange(num, dsNetProfit.__ENCList.Count - num)
					dsNetProfit.__ENCList.Capacity = dsNetProfit.__ENCList.Count
				End If
				dsNetProfit.__ENCList.Add(New WeakReference(RuntimeHelpers.GetObjectValue(value)))
			Finally
		...
		Protected Sub New(info As SerializationInfo, context As StreamingContext)
			...
			Else
				...
				If flag Then
					...
					If flag Then
						MyBase.Tables.Add(New dsNetProfit.DataTable1DataTable(dataSet.Tables("DataTable1")))
					End If
		...
		Public ReadOnly Property DataTable1 As dsNetProfit.DataTable1DataTable
			Get
		...
		Public Overrides Function Clone() As DataSet
			Dim dsNetProfit As dsNetProfit = CType(MyBase.Clone(), dsNetProfit)
			dsNetProfit.InitVars()
			dsNetProfit.SchemaSerializationMode = Me.SchemaSerializationMode
			Return dsNetProfit
		End Function
		...
		Friend Sub InitVars(initTable As Boolean)
			Me.tableDataTable1 = CType(MyBase.Tables("DataTable1"), dsNetProfit.DataTable1DataTable)
			If initTable Then
		...
		Private Sub InitClass()
			Me.DataSetName = "dsNetProfit"
			Me.Prefix = ""
			Me.[Namespace] = "http://tempuri.org/dsNetProfit.xsd"
			Me.EnforceConstraints = True
			Me.SchemaSerializationMode = SchemaSerializationMode.IncludeSchema
			Me.tableDataTable1 = New dsNetProfit.DataTable1DataTable()
		...
		Public Shared Function GetTypedDataSetSchema(xs As XmlSchemaSet) As XmlSchemaComplexType
			Dim dsNetProfit As dsNetProfit = New dsNetProfit()
			...
			xmlSchemaAny.[Namespace] = dsNetProfit.[Namespace]
			xmlSchemaSequence.Items.Add(xmlSchemaAny)
			xmlSchemaComplexType.Particle = xmlSchemaSequence
			Dim schemaSerializable As XmlSchema = dsNetProfit.GetSchemaSerializable()
		...
		Public Delegate Sub DataTable1RowChangeEventHandler(sender As Object, e As dsNetProfit.DataTable1RowChangeEvent)

		<XmlSchemaProvider("GetTypedTableSchema"), Serializable()>
		Public Class DataTable1DataTable
			Inherits TypedTableBase(Of dsNetProfit.DataTable1Row)
			...
			Private columnval3 As DataColumn
			...
			End Sub
			Private Shared Sub __ENCAddToList(value As Object)
				Dim _ENCList As List(Of WeakReference) = dsNetProfit.DataTable1DataTable.__ENCList
				Dim flag As Boolean = False
				Try
					Monitor.Enter(_ENCList, flag)
					Dim flag2 As Boolean = dsNetProfit.DataTable1DataTable.__ENCList.Count = dsNetProfit.DataTable1DataTable.__ENCList.Capacity
					If flag2 Then
						Dim num As Integer = 0
						Dim num2 As Integer = 0
						Dim num3 As Integer = dsNetProfit.DataTable1DataTable.__ENCList.Count - 1
						Dim num4 As Integer = num2
						While True
							Dim num5 As Integer = num4
							Dim num6 As Integer = num3
							If num5 > num6 Then
								Exit While
							End If
							Dim weakReference As WeakReference = dsNetProfit.DataTable1DataTable.__ENCList(num4)
							flag2 = weakReference.IsAlive
							If flag2 Then
								Dim flag3 As Boolean = num4 <> num
								If flag3 Then
									dsNetProfit.DataTable1DataTable.__ENCList(num) = dsNetProfit.DataTable1DataTable.__ENCList(num4)
								End If
								num += 1
							End If
							num4 += 1
						End While
						dsNetProfit.DataTable1DataTable.__ENCList.RemoveRange(num, dsNetProfit.DataTable1DataTable.__ENCList.Count - num)
						dsNetProfit.DataTable1DataTable.__ENCList.Capacity = dsNetProfit.DataTable1DataTable.__ENCList.Count
					End If
					dsNetProfit.DataTable1DataTable.__ENCList.Add(New WeakReference(RuntimeHelpers.GetObjectValue(value)))
				Finally
					Dim flag3 As Boolean = flag
					If flag3 Then
						Monitor.[Exit](_ENCList)
			...
			<DebuggerNonUserCode(), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Sub New()
				dsNetProfit.DataTable1DataTable.__ENCAddToList(Me)
			...
			<DebuggerNonUserCode(), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public ReadOnly Property val3Column As DataColumn
				Get
			...
			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode()>
			Public ReadOnly Property netColumn As DataColumn
				Get
					Return Me.columnnet
				End Get
			End Property
			...
			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode()>
			Public ReadOnly Default Property Item(index As Integer) As dsNetProfit.DataTable1Row
				Get
					Return CType(Me.Rows(index), dsNetProfit.DataTable1Row)
				End Get
			End Property

			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Event DataTable1RowChanging As dsNetProfit.DataTable1RowChangeEventHandler

			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Event DataTable1RowChanged As dsNetProfit.DataTable1RowChangeEventHandler

			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Event DataTable1RowDeleting As dsNetProfit.DataTable1RowChangeEventHandler

			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Event DataTable1RowDeleted As dsNetProfit.DataTable1RowChangeEventHandler

			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode()>
			Public Sub AddDataTable1Row(row As dsNetProfit.DataTable1Row)
				Me.Rows.Add(row)
			End Sub

			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode()>
			Public Function AddDataTable1Row(no As String, name As String, val1 As String, val2 As String, val3 As String, net As String, DataColumn11 As String, DataColumn1 As String) As dsNetProfit.DataTable1Row
				Dim dataTable1Row As dsNetProfit.DataTable1Row = CType(Me.NewRow(), dsNetProfit.DataTable1Row)
				Dim itemArray As Object() = New Object() { no, name, val1, val2, val3, net, DataColumn11, DataColumn1 }
			...
			Public Overrides Function Clone() As DataTable
				Dim dataTable1DataTable As dsNetProfit.DataTable1DataTable = CType(MyBase.Clone(), dsNetProfit.DataTable1DataTable)
			...
			Protected Overrides Function CreateInstance() As DataTable
				Return New dsNetProfit.DataTable1DataTable()
			End Function
			...
			Private Sub InitClass()
				...
				Me.columnval3 = New DataColumn("val3", GetType(String), Nothing, MappingType.Element)
				MyBase.Columns.Add(Me.columnval3)
				Me.columnnet = New DataColumn("net", GetType(String), Nothing, MappingType.Element)
				...
				Me.columnval3.Caption = "DataColumn1"
				Me.columnnet.Caption = "DataColumn1"
				Me.columnDataColumn11.Caption = "DataColumn1"
			End Sub

			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode()>
			Public Function NewDataTable1Row() As dsNetProfit.DataTable1Row
				Return CType(Me.NewRow(), dsNetProfit.DataTable1Row)
			End Function

			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode()>
			Protected Overrides Function NewRowFromBuilder(builder As DataRowBuilder) As DataRow
				Return New dsNetProfit.DataTable1Row(builder)
			End Function

			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode()>
			Protected Overrides Function GetRowType() As Type
				Return GetType(dsNetProfit.DataTable1Row)
			End Function
			...
			Protected Overrides Sub OnRowChanged(e As DataRowChangeEventArgs)
				...
				If flag Then
					Dim dataTable1RowChangedEvent As dsNetProfit.DataTable1RowChangeEventHandler = Me.DataTable1RowChangedEvent
					flag = (dataTable1RowChangedEvent IsNot Nothing)
					If flag Then
						dataTable1RowChangedEvent(Me, New dsNetProfit.DataTable1RowChangeEvent(CType(e.Row, dsNetProfit.DataTable1Row), e.Action))
					End If
				End If
			End Sub
			...
			Protected Overrides Sub OnRowChanging(e As DataRowChangeEventArgs)
				...
				If flag Then
					Dim dataTable1RowChangingEvent As dsNetProfit.DataTable1RowChangeEventHandler = Me.DataTable1RowChangingEvent
					flag = (dataTable1RowChangingEvent IsNot Nothing)
					If flag Then
						dataTable1RowChangingEvent(Me, New dsNetProfit.DataTable1RowChangeEvent(CType(e.Row, dsNetProfit.DataTable1Row), e.Action))
					End If
				End If
			End Sub
			...
			Protected Overrides Sub OnRowDeleted(e As DataRowChangeEventArgs)
				...
				If flag Then
					Dim dataTable1RowDeletedEvent As dsNetProfit.DataTable1RowChangeEventHandler = Me.DataTable1RowDeletedEvent
					flag = (dataTable1RowDeletedEvent IsNot Nothing)
					If flag Then
						dataTable1RowDeletedEvent(Me, New dsNetProfit.DataTable1RowChangeEvent(CType(e.Row, dsNetProfit.DataTable1Row), e.Action))
					End If
				End If
			End Sub
			...
			Protected Overrides Sub OnRowDeleting(e As DataRowChangeEventArgs)
				...
				If flag Then
					Dim dataTable1RowDeletingEvent As dsNetProfit.DataTable1RowChangeEventHandler = Me.DataTable1RowDeletingEvent
					flag = (dataTable1RowDeletingEvent IsNot Nothing)
					If flag Then
						dataTable1RowDeletingEvent(Me, New dsNetProfit.DataTable1RowChangeEvent(CType(e.Row, dsNetProfit.DataTable1Row), e.Action))
					End If
				End If
			End Sub

			<DebuggerNonUserCode(), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Sub RemoveDataTable1Row(row As dsNetProfit.DataTable1Row)
				Me.Rows.Remove(row)
			End Sub
			...
			Public Shared Function GetTypedTableSchema(xs As XmlSchemaSet) As XmlSchemaComplexType
				...
				xmlSchemaAttribute.FixedValue = dsNetProfit.[Namespace]
		...
		Public Class DataTable1Row
			...
			Friend Sub New(rb As DataRowBuilder)
				MyBase.New(rb)
				Me.tableDataTable1 = CType(Me.Table, dsNetProfit.DataTable1DataTable)
			End Sub
			...
			Public Property val3 As String
				Get
					Dim result As String
					Try
						result = Conversions.ToString(Me(Me.tableDataTable1.val3Column))
					Catch innerException As InvalidCastException
						Throw New StrongTypingException("The value for column 'val3' in table 'DataTable1' is DBNull.", innerException)
					End Try
					Return result
				End Get
				Set(value As String)
					Me(Me.tableDataTable1.val3Column) = value
				End Set
			End Property
			...
			Public Property net As String
				Get
					Dim result As String
					Try
						result = Conversions.ToString(Me(Me.tableDataTable1.netColumn))
					Catch innerException As InvalidCastException
						Throw New StrongTypingException("The value for column 'net' in table 'DataTable1' is DBNull.", innerException)
					End Try
					Return result
				End Get
				Set(value As String)
			...
			Public Function Isval3Null() As Boolean
				Return Me.IsNull(Me.tableDataTable1.val3Column)
			End Function

			<DebuggerNonUserCode(), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Sub Setval3Null()
				Me(Me.tableDataTable1.val3Column) = RuntimeHelpers.GetObjectValue(Convert.DBNull)
			End Sub
			...
			Public Sub SetnetNull()
				Me(Me.tableDataTable1.netColumn) = RuntimeHelpers.GetObjectValue(Convert.DBNull)
			End Sub
		...
		Public Class DataTable1RowChangeEvent
			...
			Private eventRow As dsNetProfit.DataTable1Row

			Private eventAction As DataRowAction

			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode()>
			Public Sub New(row As dsNetProfit.DataTable1Row, action As DataRowAction)
				Me.eventRow = row
				Me.eventAction = action
			End Sub

			<DebuggerNonUserCode(), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public ReadOnly Property Row As dsNetProfit.DataTable1Row
				Get
					Return Me.eventRow
				End Get
			End Property
