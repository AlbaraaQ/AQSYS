...
Imports System.Xml.Serialization
	<ToolboxItem(True), XmlSchemaProvider("GetTypedDataSetSchema"), DesignerCategory("code"), HelpKeyword("vs.data.DataSet"), XmlRoot("dsBanks"), Serializable()>
	Public Class dsBanks
		Inherits DataSet

		Private Shared __ENCList As List(Of WeakReference) = New List(Of WeakReference)()

		Private tableDataTable1 As dsBanks.DataTable1DataTable

		Private _schemaSerializationMode As SchemaSerializationMode
		Shared Sub New()
		End Sub
		Private Shared Sub __ENCAddToList(value As Object)
			Dim _ENCList As List(Of WeakReference) = dsBanks.__ENCList
			Dim flag As Boolean = False
			Try
				Monitor.Enter(_ENCList, flag)
				Dim flag2 As Boolean = dsBanks.__ENCList.Count = dsBanks.__ENCList.Capacity
				If flag2 Then
					Dim num As Integer = 0
					Dim num2 As Integer = 0
					Dim num3 As Integer = dsBanks.__ENCList.Count - 1
					...
					While True
						...
						If num5 > num6 Then
							Exit While
						End If
						Dim weakReference As WeakReference = dsBanks.__ENCList(num4)
						flag2 = weakReference.IsAlive
						If flag2 Then
							Dim flag3 As Boolean = num4 <> num
							If flag3 Then
								dsBanks.__ENCList(num) = dsBanks.__ENCList(num4)
							End If
							num += 1
						End If
						num4 += 1
					End While
					dsBanks.__ENCList.RemoveRange(num, dsBanks.__ENCList.Count - num)
					dsBanks.__ENCList.Capacity = dsBanks.__ENCList.Count
				End If
				dsBanks.__ENCList.Add(New WeakReference(RuntimeHelpers.GetObjectValue(value)))
			Finally
		...
		Protected Sub New(info As SerializationInfo, context As StreamingContext)
			...
			Else
				...
				If flag Then
					...
					If flag Then
						MyBase.Tables.Add(New dsBanks.DataTable1DataTable(dataSet.Tables("DataTable1")))
					End If
		...
		Public ReadOnly Property DataTable1 As dsBanks.DataTable1DataTable
			Get
		...
		Public Overrides Function Clone() As DataSet
			Dim dsBanks As dsBanks = CType(MyBase.Clone(), dsBanks)
			dsBanks.InitVars()
			dsBanks.SchemaSerializationMode = Me.SchemaSerializationMode
			Return dsBanks
		End Function
		...
		Friend Sub InitVars(initTable As Boolean)
			Me.tableDataTable1 = CType(MyBase.Tables("DataTable1"), dsBanks.DataTable1DataTable)
			If initTable Then
		...
		Private Sub InitClass()
			Me.DataSetName = "dsBanks"
			Me.Prefix = ""
			Me.[Namespace] = "http://tempuri.org/dsBanks.xsd"
			Me.EnforceConstraints = True
			Me.SchemaSerializationMode = SchemaSerializationMode.IncludeSchema
			Me.tableDataTable1 = New dsBanks.DataTable1DataTable()
		...
		Public Shared Function GetTypedDataSetSchema(xs As XmlSchemaSet) As XmlSchemaComplexType
			Dim dsBanks As dsBanks = New dsBanks()
			...
			xmlSchemaAny.[Namespace] = dsBanks.[Namespace]
			xmlSchemaSequence.Items.Add(xmlSchemaAny)
			xmlSchemaComplexType.Particle = xmlSchemaSequence
			Dim schemaSerializable As XmlSchema = dsBanks.GetSchemaSerializable()
		...
		Public Delegate Sub DataTable1RowChangeEventHandler(sender As Object, e As dsBanks.DataTable1RowChangeEvent)

		<XmlSchemaProvider("GetTypedTableSchema"), Serializable()>
		Public Class DataTable1DataTable
			Inherits TypedTableBase(Of dsBanks.DataTable1Row)
			...
			End Sub
			Private Shared Sub __ENCAddToList(value As Object)
				Dim _ENCList As List(Of WeakReference) = dsBanks.DataTable1DataTable.__ENCList
				Dim flag As Boolean = False
				Try
					Monitor.Enter(_ENCList, flag)
					Dim flag2 As Boolean = dsBanks.DataTable1DataTable.__ENCList.Count = dsBanks.DataTable1DataTable.__ENCList.Capacity
					If flag2 Then
						Dim num As Integer = 0
						Dim num2 As Integer = 0
						Dim num3 As Integer = dsBanks.DataTable1DataTable.__ENCList.Count - 1
						Dim num4 As Integer = num2
						While True
							Dim num5 As Integer = num4
							Dim num6 As Integer = num3
							If num5 > num6 Then
								Exit While
							End If
							Dim weakReference As WeakReference = dsBanks.DataTable1DataTable.__ENCList(num4)
							flag2 = weakReference.IsAlive
							If flag2 Then
								Dim flag3 As Boolean = num4 <> num
								If flag3 Then
									dsBanks.DataTable1DataTable.__ENCList(num) = dsBanks.DataTable1DataTable.__ENCList(num4)
								End If
								num += 1
							End If
							num4 += 1
						End While
						dsBanks.DataTable1DataTable.__ENCList.RemoveRange(num, dsBanks.DataTable1DataTable.__ENCList.Count - num)
						dsBanks.DataTable1DataTable.__ENCList.Capacity = dsBanks.DataTable1DataTable.__ENCList.Count
					End If
					dsBanks.DataTable1DataTable.__ENCList.Add(New WeakReference(RuntimeHelpers.GetObjectValue(value)))
				Finally
					Dim flag3 As Boolean = flag
					If flag3 Then
						Monitor.[Exit](_ENCList)
			...
			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode()>
			Public Sub New()
				dsBanks.DataTable1DataTable.__ENCAddToList(Me)
			...
			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode()>
			Public ReadOnly Default Property Item(index As Integer) As dsBanks.DataTable1Row
				Get
					Return CType(Me.Rows(index), dsBanks.DataTable1Row)
				End Get
			End Property

			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Event DataTable1RowChanging As dsBanks.DataTable1RowChangeEventHandler

			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Event DataTable1RowChanged As dsBanks.DataTable1RowChangeEventHandler

			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Event DataTable1RowDeleting As dsBanks.DataTable1RowChangeEventHandler

			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Event DataTable1RowDeleted As dsBanks.DataTable1RowChangeEventHandler

			<DebuggerNonUserCode(), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Sub AddDataTable1Row(row As dsBanks.DataTable1Row)
				Me.Rows.Add(row)
			End Sub

			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode()>
			Public Function AddDataTable1Row(name As String, country As String, city As String, area As String, tel As String, mobile As String, DataColumn11 As String, DataColumn1 As String) As dsBanks.DataTable1Row
				Dim dataTable1Row As dsBanks.DataTable1Row = CType(Me.NewRow(), dsBanks.DataTable1Row)
				Dim itemArray As Object() = New Object() { name, country, city, area, tel, mobile, DataColumn11, DataColumn1 }
			...
			Public Overrides Function Clone() As DataTable
				Dim dataTable1DataTable As dsBanks.DataTable1DataTable = CType(MyBase.Clone(), dsBanks.DataTable1DataTable)
			...
			Protected Overrides Function CreateInstance() As DataTable
				Return New dsBanks.DataTable1DataTable()
			End Function
			...
			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode()>
			Public Function NewDataTable1Row() As dsBanks.DataTable1Row
				Return CType(Me.NewRow(), dsBanks.DataTable1Row)
			End Function

			<DebuggerNonUserCode(), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Protected Overrides Function NewRowFromBuilder(builder As DataRowBuilder) As DataRow
				Return New dsBanks.DataTable1Row(builder)
			End Function

			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode()>
			Protected Overrides Function GetRowType() As Type
				Return GetType(dsBanks.DataTable1Row)
			End Function
			...
			Protected Overrides Sub OnRowChanged(e As DataRowChangeEventArgs)
				...
				If flag Then
					Dim dataTable1RowChangedEvent As dsBanks.DataTable1RowChangeEventHandler = Me.DataTable1RowChangedEvent
					flag = (dataTable1RowChangedEvent IsNot Nothing)
					If flag Then
						dataTable1RowChangedEvent(Me, New dsBanks.DataTable1RowChangeEvent(CType(e.Row, dsBanks.DataTable1Row), e.Action))
					End If
				End If
			End Sub
			...
			Protected Overrides Sub OnRowChanging(e As DataRowChangeEventArgs)
				...
				If flag Then
					Dim dataTable1RowChangingEvent As dsBanks.DataTable1RowChangeEventHandler = Me.DataTable1RowChangingEvent
					flag = (dataTable1RowChangingEvent IsNot Nothing)
					If flag Then
						dataTable1RowChangingEvent(Me, New dsBanks.DataTable1RowChangeEvent(CType(e.Row, dsBanks.DataTable1Row), e.Action))
					End If
				End If
			End Sub
			...
			Protected Overrides Sub OnRowDeleted(e As DataRowChangeEventArgs)
				...
				If flag Then
					Dim dataTable1RowDeletedEvent As dsBanks.DataTable1RowChangeEventHandler = Me.DataTable1RowDeletedEvent
					flag = (dataTable1RowDeletedEvent IsNot Nothing)
					If flag Then
						dataTable1RowDeletedEvent(Me, New dsBanks.DataTable1RowChangeEvent(CType(e.Row, dsBanks.DataTable1Row), e.Action))
					End If
				End If
			End Sub
			...
			Protected Overrides Sub OnRowDeleting(e As DataRowChangeEventArgs)
				...
				If flag Then
					Dim dataTable1RowDeletingEvent As dsBanks.DataTable1RowChangeEventHandler = Me.DataTable1RowDeletingEvent
					flag = (dataTable1RowDeletingEvent IsNot Nothing)
					If flag Then
						dataTable1RowDeletingEvent(Me, New dsBanks.DataTable1RowChangeEvent(CType(e.Row, dsBanks.DataTable1Row), e.Action))
					End If
				End If
			End Sub

			<DebuggerNonUserCode(), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Sub RemoveDataTable1Row(row As dsBanks.DataTable1Row)
				Me.Rows.Remove(row)
			End Sub
			...
			Public Shared Function GetTypedTableSchema(xs As XmlSchemaSet) As XmlSchemaComplexType
				...
				xmlSchemaAttribute.FixedValue = dsBanks.[Namespace]
		...
		Public Class DataTable1Row
			...
			Friend Sub New(rb As DataRowBuilder)
				MyBase.New(rb)
				Me.tableDataTable1 = CType(Me.Table, dsBanks.DataTable1DataTable)
			End Sub
		...
		Public Class DataTable1RowChangeEvent
			...
			Private eventRow As dsBanks.DataTable1Row

			Private eventAction As DataRowAction

			<DebuggerNonUserCode(), GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Sub New(row As dsBanks.DataTable1Row, action As DataRowAction)
				Me.eventRow = row
				Me.eventAction = action
			End Sub

			<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode()>
			Public ReadOnly Property Row As dsBanks.DataTable1Row
				Get
					Return Me.eventRow
				End Get
			End Property
